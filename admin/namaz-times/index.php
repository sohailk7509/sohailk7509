                                ...
                                <form method="post" action="process/add-prayer-times.php">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="city" class="form-control" required>
                                                    ...
                                                    <option value="Peshawar">پشاور</option>
                                                    <option value="Quetta">کوئٹہ</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>تاریخ</label>
                                                <input type="number" name="date" min="1" max="31" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit.php?id=<?php echo $time['id']; ?>" class="btn btn-sm btn-info">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="delete.php?id=<?php echo $time['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('کیا آپ واقعی حذف کرنا چاہتے ہیں؟')">
